...
$img->code_length = 5; // 8 ao invés de apenas 4 caracteres
$img->charset = "23456789bcdfghjkmnpqrstvwxyz"; // palavras que podem aparecer
//$img->image_width = 275;
$img->image_height = 45;
//$img->perturbation = 0.9; // 1.0 = high distortion, higher numbers = more distortion
$img->image_bg_color = new Securimage_Color("#EEEEEE");
