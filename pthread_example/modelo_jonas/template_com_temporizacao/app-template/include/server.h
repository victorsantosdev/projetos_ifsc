...
#define SERVER_RX_T2RUN       "T2RUN"        // requisitar ação RUN da task 2
#define SERVER_RX_T2STOP      "T2STOP"       // requisitar ação STOP da task 2
#define SERVER_RX_T2TIMER     "T2TIMER"      // requisitar ação TIMER da task 2
...
#define SERVER_TX_T2RUN       "T2RUN"        // resposta ao pacote T2RUN
#define SERVER_TX_T2STOP      "T2STOP"       // resposta ao pacote T2STOP
#define SERVER_TX_T2TIMER     "T2TIMER"      // resposta ao pacote T2TIMER
