...
#define DEFINE_STRINGCNT(NM, PTR, LEN) {NM, CONF_TYPE(CONF_STRING), (void *)(PTR), LEN},
...
#define DEFINE_IPADDR(NM, PTR) {NM,  CONF_TYPE(CONF_IPADDR), (void *)(PTR), 0},
#define DEFINE_IPPORT(NM, PTR) {NM,  CONF_TYPE(CONF_IPADDR), (void *)(PTR), 0},
...
extern "C" {
	...
	int conf_dump(struct conf_var *);
	int conf_load(const char *, struct conf_var *);
	int conf_save(const char *, struct conf_var *);
